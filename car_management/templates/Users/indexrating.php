        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $rating->has('car') ? $this->Html->link($rating->car->name, ['controller' => 'Users', 'action' => 'viewcar', $rating->car->id]) : '' ?></td>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'viewrating', $rating->id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'editrating', $rating->id]) ?>
